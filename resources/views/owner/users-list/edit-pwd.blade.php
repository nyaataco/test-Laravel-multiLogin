...
<div class="mid:w-10/12 lg:w-4/5 mx-auto mb-10">
    ...
    <form method="post" action="{{ route('owner.users-list.update-pwd', ['id' => $user_id]) }}" class="space-y-10 mb-10">
        @csrf
        @method('patch')
    ...
    <a href="{{ route('owner.users-list.show', ['id' => $user_id]) }}" class="text-sky-600">
        戻る
    </a>
